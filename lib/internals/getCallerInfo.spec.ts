    ...
    spyError.mockImplementation(() => {
      let stack =
        ...
        (nextJsVersion === 12_0_9
          ? `Error
  at Object.getCallerInfo (/unix-example-path/node_modules/@instantcommerce/next-api-decorators/dist/internals/getCallerInfo.js:9:30)
  at createHandler (/unix-example-path/node_modules/@instantcommerce/next-api-decorators/dist/createHandler.js:30:51)
